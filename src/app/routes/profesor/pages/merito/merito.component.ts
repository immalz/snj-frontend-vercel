...
@Component({
  selector: 'app-merito',
  templateUrl: './merito.component.html',
  styleUrls: ['./merito.component.scss'],
  providers: [
    DatePipe,
    {
      provide: DateAdapter,
...
export class MeritoComponent implements OnInit {
  ...
  setNotes(notes): void {
    for (const student of this.studentList) {
      student.nota = null;
      const found = notes.find(element => student.alumno === element.alumno[0]);
